...
const enPublicationsPageData = {
    ...
    type_one_items: [
   {
    ...
    {
      title: `Luongo M., Xie, S.-P., Eisenman I., & <strong>Peng, Q.</strong>,. How the Subsurface Tropical Pacific Responds to Hemispherically Asymmetric Temperature Forcing: Implications for Cross-Equatorial Mass and Heat Transport. Journal of Climate (Accepted).`,
      abstract: ``,
      date: "",
      link: "",
      github: "",
   ...
   {
      title: `Taylor, B. A., Shi, J.-R., Xie, S.-P., Talley, L. D., Luongo, M. T., & <strong>Peng, Q.</strong> (2024). Warming band in Southern Ocean’s Indian sector: The role of remote Atlantic buoyancy forcing via poleward-shifting circulation response. Journal of Climate (Accepted) `,
      abstract: ``,
      date: "",
      link: "",
      github: "",
